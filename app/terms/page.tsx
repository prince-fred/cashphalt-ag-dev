        ...
        <div className="min-h-screen bg-concrete-grey flex flex-col items-center p-4 md:p-8">
            <div className="w-full max-w-4xl">
                ...
                <Card className="rounded-t-none border-t-0 shadow-xl p-8 prose prose-slate max-w-none">
                    ...
                    <p>
                        Welcome to Axis Parking Parking Solutions, LLC ("Axis Parking," "we," "us," or "our"). These Terms and Conditions ("Terms") govern your access to and use of our parking payment and software solutions, including our mobile application, website, and related services (collectively, the "Platform" or "Services"). By creating an account, installing our application, or using our Services in any manner, you agree to be legally bound by these Terms.
                    </p>
                    ...
                    <p>
                        Axis Parking provides a technology platform that enables digital parking payment processing, permit management, and related parking services. We act as a software service provider facilitating transactions between users and parking operators, property owners, and parking management companies ("Parking Operators"). Axis Parking does not own, operate, or manage parking facilities and is not responsible for the day-to-day operations of parking locations. We facilitate payment processing through third-party payment processors but do not directly process credit card payments ourselves.
                    </p>
                    ...
                    <p>You may use the Platform solely for lawful purposes and in accordance with these Terms. You agree to use the Services only for personal, non-commercial parking payment transactions unless expressly authorized by Axis Parking in writing.</p>
                    ...
                    <ul>
                        ...
                        <li>Violate or infringe upon the intellectual property rights of Axis Parking or any third party;</li>
                    ...
                    <ul>
                        <li>Axis Parking does not enforce parking regulations, issue citations, or assess parking penalties. All enforcement actions are undertaken by Parking Operators or authorized enforcement entities.</li>
                        ...
                        <li>Axis Parking is not liable for any citations, fines, penalties, towing, booting, or other enforcement actions taken against your vehicle, even if you used the Platform for the associated parking session and even if the issue was related to payment processing failures.</li>
                    ...
                    <h4>7.1 Ownership</h4>
                    <p>The Platform and all content, features, and functionality, including but not limited to software, text, graphics, logos, images, audio, video, data compilations, and the overall design, are owned by Axis Parking Parking Solutions, LLC, its licensors, or other content providers and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property laws.</p>

                    <h4>7.2 Limited License</h4>
                    <p>Subject to your compliance with these Terms, Axis Parking grants you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to access and use the Platform for your personal, non-commercial use. This license does not include any right to: (a) resell or make commercial use of the Platform; (b) modify or make derivative works of the Platform; (c) download or copy content except as expressly permitted; (d) use data mining, robots, or similar data gathering tools; or (e) use the Platform in any manner that could damage or overburden our systems.</p>

                    <h4>7.3 Trademarks</h4>
                    <p>AXIS PARKING and all related logos, product and service names, designs, and slogans are trademarks of Axis Parking Parking Solutions, LLC. You may not use such marks without our prior written permission. All other names, logos, and marks are the property of their respective owners.</p>
                    ...
                    <p>Axis Parking does not warrant that:</p>
                    <ul>
                    ...
                    <p className="uppercase">You acknowledge that Axis Parking has no control over parking facilities, payment processor operations, or third-party services, and you assume all risks associated with parking your vehicle, including but not limited to damage, theft, loss of property, and personal injury. AXIS PARKING IS NOT RESPONSIBLE FOR THE SAFETY OR SECURITY OF YOUR VEHICLE OR BELONGINGS AT ANY PARKING LOCATION, NOR FOR ANY FAILURES OR ERRORS BY THIRD-PARTY PAYMENT PROCESSORS.</p>

                    <h3>9. LIMITATION OF LIABILITY</h3>
                    <p className="uppercase font-bold">TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL AXIS PARKING PARKING SOLUTIONS, LLC, ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, OR LICENSORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOST PROFITS, LOST REVENUE, LOST DATA, PARKING CITATIONS, TOWING FEES, VEHICLE DAMAGE, OR BUSINESS INTERRUPTION, ARISING OUT OF OR RELATING TO YOUR USE OF OR INABILITY TO USE THE PLATFORM, PAYMENT PROCESSING FAILURES, OR THE ACTS OR OMISSIONS OF THIRD-PARTY PAYMENT PROCESSORS, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), STATUTE, OR ANY OTHER LEGAL THEORY, EVEN IF AXIS PARKING HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
                    <p className="uppercase font-bold">TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE TOTAL LIABILITY OF AXIS PARKING FOR ANY CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS OR THE PLATFORM SHALL NOT EXCEED THE GREATER OF: (A) THE AMOUNT YOU PAID TO AXIS PARKING IN SERVICE FEES (NOT INCLUDING PARKING CHARGES PASSED THROUGH TO PARKING OPERATORS) IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING RISE TO LIABILITY, OR (B) ONE HUNDRED DOLLARS ($100.00).</p>
                    <p>You acknowledge that the parking fees and other charges you pay through the Platform are paid to Parking Operators, not to Axis Parking. Axis Parking's role is limited to facilitating these transactions through our Platform and third-party payment processors. Accordingly, Axis Parking's liability is limited as set forth above and does not extend to amounts paid to Parking Operators or payment processors.</p>
                    ...
                    <p>You and Axis Parking agree that any dispute, claim, or controversy arising out of or relating to these Terms, your use of the Platform, or any transactions facilitated through the Platform (including disputes related to payment processing) shall be settled by binding arbitration administered by the American Arbitration Association ("AAA") in accordance with its Commercial Arbitration Rules, except as modified by this Section. The arbitration shall be conducted before a single arbitrator and shall be limited solely to the dispute between you and Axis Parking.</p>

                    <h4>13.2 Class Action Waiver</h4>
                    <p className="uppercase font-bold">YOU AND AXIS PARKING AGREE THAT EACH PARTY MAY BRING CLAIMS AGAINST THE OTHER ONLY IN AN INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE ACTION OR PROCEEDING. UNLESS BOTH YOU AND AXIS PARKING AGREE OTHERWISE, THE ARBITRATOR MAY NOT CONSOLIDATE OR JOIN MORE THAN ONE PERSON'S OR PARTY'S CLAIMS AND MAY NOT OTHERWISE PRESIDE OVER ANY FORM OF A CONSOLIDATED, REPRESENTATIVE, OR CLASS PROCEEDING.</p>
                    ...
                    <p>You may opt out of this arbitration agreement by sending written notice to Axis Parking within thirty (30) days of first accepting these Terms. The notice must include your name, address, email address associated with your account, and a clear statement that you wish to opt out of this arbitration agreement. Send the opt-out notice to: [Your Physical Address] or [legal@axisparking.io]. If you opt out, all other provisions of these Terms will continue to apply, but disputes will be resolved in court as set forth in Section 14 below.</p>
                    ...
                    <p>These Terms, together with our Privacy Policy and any other legal notices or agreements published on the Platform, constitute the entire agreement between you and Axis Parking regarding your use of the Platform and supersede all prior agreements and understandings, whether written or oral.</p>
