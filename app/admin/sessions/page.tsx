...
function StatusBadge({ status }: { status: string }) {
    // If a session arrives strictly as COMPLETED from the DB, display it as EXPIRED
    const displayStatus = status === 'COMPLETED' ? 'EXPIRED' : status
    ...
    const style = styles[displayStatus] || 'bg-slate-100 text-slate-500'
